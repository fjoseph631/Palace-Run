...
/* 
    void ignoreCollisions()
    {
        ...
        private GameObject obsticle= GameObject.findWithTag("obsticle");
        private GameObject tiger= GameObject.findWithTag("GameController");
        private var obsticleCollider = obsticle.GetComponent<>();
        private var tigerCollider = tiger.GetComponent<>();
        //Both are enabled
